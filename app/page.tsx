...
export default function Home() {
  ...
  const merchProducts: Product[] = [
    {
      ...
      status: "Pre-order",
      fullDescription: "Crafted from premium heavyweight cotton, this black hoodie features intricate gold embroidery of the YH logo. Perfect for everyday comfort with a touch of luxury.",
      sizes: ["S", "M", "L", "XL", "XXL"],
    ...
    },
    {
      ...
      status: "Pre-order",
      fullDescription: "100% premium cotton tee featuring exclusive YH artwork on the front. Soft, breathable, and perfect for showing your support in style.",
      sizes: ["S", "M", "L", "XL"],
    ...
    },
    {
      ...
      status: "Pre-order",
      fullDescription: "Structured six-panel cap with a curved visor and metallic YH logo patch. Adjustable strap for perfect fit.",
      sizes: ["One Size"],
    ...
    },
    {
      ...
      status: "Pre-order",
      fullDescription: "Limited edition 180g vinyl featuring exclusive artwork. Includes digital download code and behind-the-scenes booklet.",
      sizes: ["12-inch"],
    ...
    },
    {
      ...
      status: "Exclusive",
      fullDescription: "The ultimate fan bundle including hoodie, tee, cap, and vinyl. Plus early access to future releases and exclusive content.",
      sizes: ["Bundle"],
      colors: ["Complete Set"]
    },
    {
      ...
      status: "New",
      fullDescription: "Warm and comfortable acrylic blend beanie with woven YH logo. One size fits all.",
      sizes: ["One Size"],
    ...
    },
    {
      ...
      status: "Limited",
      fullDescription: "Lightweight track jacket with detailed embroidery on chest and sleeves. Perfect for layering.",
      sizes: ["S", "M", "L", "XL"],
    ...
    },
    {
      ...
      status: "In Stock",
      fullDescription: "Set of 5 high-quality vinyl stickers featuring YH logos and artwork. Weather-resistant and perfect for laptops, water bottles, and more.",
      sizes: ["Pack of 5"],
      colors: ["Mixed Colors"]
    },
    {
      ...
      status: "Eco",
      fullDescription: "Durable canvas tote bag made from eco-friendly materials. Perfect for everyday use with bold YH print.",
      sizes: ["One Size"],
    ...
    },
    {
      ...
      description: "Protective case with YH artwork",
      status: "New",
      fullDescription: "Durable protective phone case featuring exclusive YH artwork. Compatible with most smartphone models.",
      sizes: ["Universal"],
  ...
  //       color: selectedColor
  //     });
  //     // Here you would update your cart context/state
  //     closeProductModal();
  //   }
  // };
    ...
    <div className="min-h-screen bg-black font-sans">
      ...
      {/* <section className="relative min-h-screen flex items-center justify-center overflow-hidden"> */}
        ...
        {/* <div className="relative z-20 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto"> */}
          ...
          {/* <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl mx-auto">
            <div className="text-center">
              <div className="text-yellow-400 text-2xl font-bold mb-1">10+</div>
    ...
    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 md:gap-8 mb-12">
      {merchProducts.map((product) => (
        ...
        >
          ...
          {/* Product Info - Adjusted text sizes for mobile */}
          <div className="text-center">
